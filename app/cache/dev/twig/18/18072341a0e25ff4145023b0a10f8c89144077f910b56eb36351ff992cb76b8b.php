...
class __TwigTemplate_285bbfcf5ac9e666219288a5d3f768b2c6652b0c3e4c700446bdf952cba7e555 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("RepGestionBundle:Rep:detail.html.twig", "RepGestionBundle:Rep:addCompte.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_detail($context, array $blocks = array())
    {
        ...
        if (((isset($context["update"]) ? $context["update"] : $this->getContext($context, "update")) == 1)) {
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["compte"]) ? $context["compte"] : $this->getContext($context, "compte")), "personnel", array()), "html", null, true);
            echo " ";
        } else {
        ...
        if (((isset($context["update"]) ? $context["update"] : $this->getContext($context, "update")) == 1)) {
            echo " value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["compte"]) ? $context["compte"] : $this->getContext($context, "compte")), "motPasse", array()), "html", null, true);
            echo "\" ";
        }
...
";
    ...
    {
        return array (  134 => 43,  130 => 42,  120 => 39,  108 => 34,  100 => 29,  96 => 27,  87 => 25,  83 => 24,  73 => 23,  56 => 13,  50 => 9,  47 => 8,  44 => 7,  41 => 6,  38 => 5,  35 => 4,  29 => 2,  11 => 1,);
    }
}
/* {% extends "RepGestionBundle:Rep:detail.html.twig" %}*/
/* {% block title %}Ajout d'un Compte{% endblock %}*/
/* */
/* {% block detail %}*/
/*     {% set update = 0 %}*/
...
/*              margin-left: -15px;*/
/*              margin-right: -25px;">*/
/*             <strong style="font-size: 18px"><u>{% if update == 1 %} Modification d'un Compte {% else %}Ajout d'un nouveau Compte {% endif %}</u></b></h4></u></strong>*/
/*         </div>*/
/*         <form class="col-md-12 form-inline panel panel-primary panel-body"*/
/*               style="*/
/*               margin-left: -15px;*/
...
/*                 <label for="poste" class="col-md-4">Titulaire <span style="color: red">*</span></label>*/
/*                 <b><select onfocus="editerFocus('preCP', 'pren');" id="prenP" class="form-control" style="font-size: 16px;">*/
/*                         <option value="" class="form-control" selected>{% if update == 1 %} {{ compte.personnel }} {% else %} Choisir le titulaire {% endif %}</option>*/
/*                         {% for occupant in listOccupant %}*/
/*                             <option value="categorie.id" class="form-control" style="font-size: 16px; font-weight: bold; color: black;">{{occupant}}</option>*/
/*                         {% endfor %}*/
/*                     </select><span class="glyphicon glyphicon-remove form-control-feedback hide pren ">*/
/*                 </b>*/
/*                 <a href="{{ path('add_personnel') }}" style="font-size: 16px; cursor: pointer; margin-left: 20px" class=""><span class="glyphicon glyphicon-plus-sign"><u><b>Titulaire innexistant</b></u></span></a>*/
/*             </div>*/
/*             <div class="col-md-12 form-group matCP"*/
/*                  style="margin-top: 5px;">*/
/*                 <label for="poste" class="col-md-4 control-label">Login <span style="color: red">*</span></label>*/
/*                 <b><input onfocus="editerFocus('matCP', 'mat');" type="text" {% if update == 1 %} value="{{ compte.login }}" {% endif %}class="form-control" id="matP" placeholder="Login du compte" style="font-size: 16px;"><span class="glyphicon glyphicon-remove form-control-feedback hide mat "></b>*/
/*             </div>*/
/*             <div class="col-md-12 form-group telCP"*/
/*                  style="margin-top: 5px;">*/
/*                 <label for="poste" class="col-md-4">Mot de passe <span style="color: red">*</span></label>*/
/*                 <b><input onfocus="editerFocus('telCP', 'tel');" type="text" {% if update == 1 %} value="{{ compte.motPasse }}" {% endif %} class="form-control" id="telP" placeholder="Mot de passe" style="font-size: 16px;"><span class="glyphicon glyphicon-remove form-control-feedback hide tel "></b>*/
/*             </div>*/
/*         </form>*/
...
/*         <a><button onclick="validationCompte();" type="button" class="btn btn-primary col-md-2 col-md-offset-1"><span class="glyphicon glyphicon-plus-sign">{% if update == 1 %}Modifier{% else %}Ajouter{% endif %}</span></button></a>*/
/*     </div>*/
/* {% endblock %}*/
