...
";
    ...
    {
        return array (  169 => 53,  163 => 50,  149 => 45,  137 => 36,  134 => 35,  125 => 33,  121 => 32,  111 => 31,  102 => 25,  99 => 24,  90 => 22,  86 => 21,  76 => 20,  63 => 14,  50 => 9,  47 => 8,  44 => 7,  41 => 6,  38 => 5,  35 => 4,  29 => 2,  11 => 1,);
    }
}
...
/*              style="margin-top: 5px;">*/
/*             <label for="poste" class="col-md-4 control-label">Nom du poste <span style="color: red">*</span></label>*/
/*             <b><input onfocus="editerFocus('nomCP', 'nom');" {% if update == 1 %} value="{{posted }}" {% endif %} type="text" class="form-control poste-class" id="nomP" placeholder="Nom du poste" style="font-size: 16px;"><span class="glyphicon glyphicon-remove form-control-feedback hide nom "></b>*/
/*         </div>*/
/*         <div class="col-md-12 form-group preCP"*/
/*              style="margin-top: 5px;">*/
/*             <label for="categorie" class="col-md-4 control-label">Categorie <span style="color: red">*</span></label>*/
/*             <b><select onfocus="editerFocus('preCP', 'pren');" id="prenP" class="form-control" style="font-size: 16px;">*/
/*                     <option value="" class="form-control" selected >{% if update == 1 %} {{posted.categorie }} {% else %}Choisir sa categorie {% endif %}</option>*/
...
/*             <label for="poste" class="col-md-4 control-label">Occupant <span style="color: red">*</span></label>*/
/*             <b><select onfocus="editerFocus('matCP', 'mat');" id="matP" class="form-control" style="font-size: 16px;">*/
/*                     <option value="" class="form-control" selected>{% if update == 1 %} {{posted.occupant }} {% else %} Choisir l'occupant {% endif %}</option>*/
...
/*             <a href="{{ path('add_personnel') }}" style="font-size: 16px; cursor: pointer; margin-left: 20px" class=""><span class="glyphicon glyphicon-plus-sign"><u><b>Nouveau personnel</b></u></span></a>*/
/*         </div>*/
/*         <div class="col-md-12 form-group"*/
/*              style="margin-top: 5px;">*/
/*             <label for="poste" class="col-md-4">Observation</label>*/
...
/*                       width: 250px;*/
/*                       font-size: 16px;*/
/*                       height: 151px;"> {% if update == 1 %} {{posted.observation }} {% else %} Observations{% endif %} </textarea>*/
/*         </div>*/
/*         <div class="col-md-12 form-group"*/
/*              style="margin-top: 5px;">*/
/*             <label for="poste" class="col-md-4">Rataché à: <span style="color: red">*</span></label>*/
